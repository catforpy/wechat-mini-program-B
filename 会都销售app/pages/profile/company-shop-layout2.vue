  ...
  <view class="company-shop-page">
    ...
    <view class="nav-bar" :style="{ paddingTop: statusBarHeight + 'px' }">
      <view class="nav-content">
        ...
        <view class="nav-title">我的公司 (版体2)</view>
          ...
          >
            ...
            <view class="company-header">
              ...
              <view
                ...
                class="add-program-btn-floating"
...
const allCompanies = ref<Company[]>([
  {
    ...
    miniPrograms: [
      ...
      { id: '1-4', name: '太湖在线', emoji: '💻', category: '在线教育', status: 'certifying', statusText: '认证中' },
      { id: '1-5', name: '太湖考试', emoji: '📝', category: '考试系统', status: 'publishing', statusText: '上架中' }
    ]
  },
  {
    id: '2',
