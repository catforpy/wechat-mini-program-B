  ...
  <view class="leasings-page">
    ...
    <view class="nav-bar" :style="{ paddingTop: statusBarHeight + 'px' }">
      <view class="nav-content">
        ...
        <text class="nav-title">我的租赁</text>
    ...
    <scroll-view class="main-content" scroll-y :style="{ paddingTop: (statusBarHeight + 88) + 'px' }">
      ...
      <view v-else class="empty-state">
        ...
        <text class="empty-hint">添加租赁资质后可以管理租赁小程序</text>
      </view>
...
const loadLeasings = () => {
  try {
    ...
    if (saved) {
      leasingApps.value = JSON.parse(saved)
    }
  } catch (e) {
    console.error('加载租赁列表失败:', e)
  }
}
